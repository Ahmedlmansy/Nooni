  ...
  const sliderContnet = [
    {
      ...
      category: "garden",
      description:
        "A stylish and comfortable chair for your garden, perfect for relaxing on sunny days.",
      image_path: "/imgContent_1.png",
    },
    {
    ...
    },
    {
      ...
      category: "lamp",
      description:
        "A luxurious mattress designed to provide ultimate comfort and support for a restful night's sleep. Crafted from high-quality materials, it features a breathable cover and multiple layers of cushioning to ensure a perfect fit for your body.",
      image_path: "/imgContent_3.png",
    },
  ];
  return (
